...
*/
export class ReferralListResponse {
    'success'?: number;
    'referrals'?: Array<ReferralListResponseReferralsInner>;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "referrals",
            "baseName": "referrals",
            "type": "Array<ReferralListResponseReferralsInner>",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ReferralListResponse.attributeTypeMap;
    }
